...
class JoinHope(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if "join hope" == message.content.lower():
            await message.delete()
            embed = discord.Embed(description=f"If you are looking to join Team Hope, make sure to check out the <#681999546028392639 > channel! Please watch the video relating to what team you want to join: Valorant, COD, or Fortnite.\n\nHere are some extra tips to help you join! `1` Use our tags (#Hope8KRC, #HopeOnTop, #HopeWZRC, #HopeVLTRC)\n`2` Be active in our discord server! This is one of the best ways to get recognised!  Good luck grinding!",color=0x06c9ff)
            ...
            await message.author.send(embed=emebd)

        if "how join hope" in message.content.lower():
            await message.delete()
